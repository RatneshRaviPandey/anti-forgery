...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://infometa.in/verify" },
...
export default function VerifyPage() {
  return (
    <div className="mx-auto max-w-2xl px-4 py-8 sm:px-6 sm:py-12">
      ...
      <Suspense fallback={<div className="text-center py-12 text-secondary">Loading verifier...</div>}>
        <VerifyClient />
      </Suspense>
    </div>
  );
